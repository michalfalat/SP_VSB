...
def main():
    ...
    optional.add_argument('--model_name', dest='modelName', action='store', help='Final name of trained mobel', default='defaultModel.dat')
    ...
    optional.add_argument('--epochs', dest='epochs', action='store', type=int, help='Number of epochs', default=2)
