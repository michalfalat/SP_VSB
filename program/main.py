...
def main():
    ...
    optional.add_argument('--save-train-image', dest='saveTrainImage', action='store', help='If train image for neural network should be saved', default=False)
    optional.add_argument('--save-train-image-path', dest='saveTrainImagePath', action='store', help='path for saving train image', default='./program/train_nn/')
