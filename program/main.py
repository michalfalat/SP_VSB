...
def main():
    ...
    optional.add_argument('--model_name', dest='modelName', action='store', help='Final name of trained model', default='defaultModel.dat')
    ...
    optional.add_argument('--save-train_image_path', dest='saveTrainImagePath', action='store', help='path for saving train image', default='defaultModel.dat')
