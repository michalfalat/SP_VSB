...
def initialize(model = "MPI"):
    try:
        ...
        # parser.add_argument("--image_path", default="C:/Diploma/openpose/examples/media/COCO_val2014_000000000192.jpg", help="Process an image. Read all standard formats (jpg, png, bmp, etc.).")
        # parser.add_argument("--image_path", default="C:/Users/Asus/Documents/Projekty/SP_VSB/images360/HernandezVR_web-824x549.jpg", help="Process an image. Read all standard formats (jpg, png, bmp, etc.).")
